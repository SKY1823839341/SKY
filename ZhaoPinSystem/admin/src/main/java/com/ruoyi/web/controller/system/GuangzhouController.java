 ...
 */
@Controller
@RequestMapping("/system/guangzhou")
public class GuangzhouController extends BaseController
{
    private String prefix = "system/guangzhou";

    @Autowired
    private ICityService cityService;

    @RequiresPermissions("system:guangzhou:view")
    @GetMapping()
    public String city()
    {
        return prefix + "/guangzhou";
    }
