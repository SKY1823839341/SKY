 ...
 */
@Controller
@RequestMapping("/system/shanghai")
public class ShanghaiController extends BaseController
{
    private String prefix = "system/shanghai";

    @Autowired
    private ICityService cityService;

    @RequiresPermissions("system:shanghai:view")
    @GetMapping()
    public String city()
    {
        return prefix + "/shanghai";
    }
